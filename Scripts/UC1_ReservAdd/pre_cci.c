# 1 "d:\\vugen\\scripts\\uc1_reservadd\\\\combined_UC1_ReservAdd.c"
...
# 1 "d:\\vugen\\scripts\\uc1_reservadd\\\\combined_UC1_ReservAdd.c" 2
...
# 2 "d:\\vugen\\scripts\\uc1_reservadd\\\\combined_UC1_ReservAdd.c" 2
...
# 1 "../fileDat/lib.h" 1
void reserv_1(char* depart_City,char* departDate,char* arrive_City,int numPassengerRand,char* seat_Pref,char* seat_Type)
{
...
# 3 "d:\\vugen\\scripts\\uc1_reservadd\\\\combined_UC1_ReservAdd.c" 2
...
# 4 "d:\\vugen\\scripts\\uc1_reservadd\\\\combined_UC1_ReservAdd.c" 2
...
web_reg_find("Text=Welcome to the Web Tours site.","LAST");
	...
	reserv_1(lr_eval_string("{depart_City}"),lr_eval_string("{departDate}"),lr_eval_string("{arrive_City}"),
	         atoi(lr_eval_string("{numPassengerRand}")),lr_eval_string("{seat_Pref}"),lr_eval_string("{seat_Type}"));
...
reserv_2(atoi(lr_eval_string("{numPassengerRand}")),lr_eval_string("{seat_Pref}"),lr_eval_string("{seat_Type}"));
...
# 5 "d:\\vugen\\scripts\\uc1_reservadd\\\\combined_UC1_ReservAdd.c" 2
...
# 6 "d:\\vugen\\scripts\\uc1_reservadd\\\\combined_UC1_ReservAdd.c" 2
