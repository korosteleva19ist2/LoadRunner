# 1 "d:\\vugen\\scripts\\uc2_registrationreservaddview\\\\combined_UC2_RegistrationReservAddView.c"
...
# 1 "d:\\vugen\\scripts\\uc2_registrationreservaddview\\\\combined_UC2_RegistrationReservAddView.c" 2
...
# 2 "d:\\vugen\\scripts\\uc2_registrationreservaddview\\\\combined_UC2_RegistrationReservAddView.c" 2
...
# 3 "d:\\vugen\\scripts\\uc2_registrationreservaddview\\\\combined_UC2_RegistrationReservAddView.c" 2
...
# 4 "d:\\vugen\\scripts\\uc2_registrationreservaddview\\\\combined_UC2_RegistrationReservAddView.c" 2
...
Action()
{
	...
	int i;
	int randNumber;
	lr_start_transaction("UC2_RegistrationReservAddView");
...
lr_start_transaction("StartWebTours");
	...
	lr_end_transaction("ToRegistrationPage",2);
...
lr_end_transaction("LogIn", 2);
	...
	lr_end_transaction("ToFlihgtsPage",2);
	...
	web_submit_data("insert_data_flight", 
	...
	web_reg_find("Text=Total Charged to Credit Card # {newCreditCard}","LAST");
	...
	if(randNumber==1)
	{
		...
		web_submit_data("insert_payment_info",
		"Action=http://localhost:1080/cgi-bin/reservations.pl", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=text/html", 
		...
		"Name=address1", "Value={newStreetUser}", "ENDITEM", 
		"Name=address2", "Value={newCityUser}", "ENDITEM", 
		"Name=pass1", "Value={newFirstName} {newLastName}", "ENDITEM", 
		"Name=creditCard", "Value={newCreditCard}", "ENDITEM", 
		"Name=expDate", "Value={newExpCreditCard}", "ENDITEM", 
	...
	if(randNumber==1)
		web_reg_find("Text=A {seat_Type} class ticket","LAST");
	else if(randNumber>1)
		web_reg_find("Text={numPassengerRand} {seat_Type} class ticket","LAST");
	 
	web_reg_find("Text={newFirstName} {newLastName}","LAST");
	 
	web_reg_find("Text=Itinerary","LAST");
	 
	web_reg_find("Text={fligting}","LAST");
	...
	lr_end_transaction("ViewTicket",2);
	...
	lr_end_transaction("UC2_RegistrationReservAddView", 2);

	return 0;
}
# 5 "d:\\vugen\\scripts\\uc2_registrationreservaddview\\\\combined_UC2_RegistrationReservAddView.c" 2
...
# 6 "d:\\vugen\\scripts\\uc2_registrationreservaddview\\\\combined_UC2_RegistrationReservAddView.c" 2
