...
/*Correlation comment - Do not change!  Original value='137628.968327258HAHQcQApAfiDDDDDtctHfpHtADf' Name ='userSession' Type ='ResponseBased'*/
	...
	//web_reg_find("Text=name=\"flightID\" value=\"","SaveCount=Welcome_Count",LAST);
	...
	lr_end_transaction("UC4_ReservViewDelete",LR_AUTO);
