# 1 "d:\\vugen\\scripts\\uc4_reservviewdelete\\\\combined_UC4_ReservViewDelete.c"
...
# 1 "d:\\vugen\\scripts\\uc4_reservviewdelete\\\\combined_UC4_ReservViewDelete.c" 2
...
# 2 "d:\\vugen\\scripts\\uc4_reservviewdelete\\\\combined_UC4_ReservViewDelete.c" 2
...
# 1 "D:\\Micro Focus\\LoadRunner\\include/lrw_custom_body.h" 1
...
# 3 "d:\\vugen\\scripts\\uc4_reservviewdelete\\\\combined_UC4_ReservViewDelete.c" 2
...
# 4 "d:\\vugen\\scripts\\uc4_reservviewdelete\\\\combined_UC4_ReservViewDelete.c" 2

# 1 "Action.c" 1
Action()
{
	lr_start_transaction("UC4_ReservViewDelete");
	...
	lr_save_string("pasha","login");
	lr_save_string("2222","password");
	...
	if(atoi(lr_eval_string("{countFlight}"))>1)
	{
	   	web_reg_save_param("Flighting",
	                   "lb=name=\"flightID\" value=\"",
	                   "rb=\"",
	                   "ord=all",
	                   "LAST");
	...
	if(atoi(lr_eval_string("{countFlight}"))>0&&atoi(lr_eval_string("{countFlight}"))<=2)
	{
	...
	else if(atoi(lr_eval_string("{countFlight}"))<=4)
	{
		web_reg_find("Text=name=\"flightID\" value=\"{Flight_1}\"","fail=found","LAST");
	...
	lr_end_transaction("UC4_ReservViewDelete",2);

	return 0;
}
# 5 "d:\\vugen\\scripts\\uc4_reservviewdelete\\\\combined_UC4_ReservViewDelete.c" 2
...
# 6 "d:\\vugen\\scripts\\uc4_reservviewdelete\\\\combined_UC4_ReservViewDelete.c" 2
